...
<br> <br>
  ...
  <div style="display: flex; justify-content: center;">
  <img class="vision" src="img/set/pc/bnr_vision_pc.png" alt="vision">
</div>
<div style="display:flex; justify-content:center; align-items: center; height: 15vh;">
<img src="img/set/img_logo_l5_f.png" alt="lvl5" style="display:flex; align-items:center; height: 45px; width: 100px;">
</div>
<div style="display: flex; justify-content: center;">
...
<div class="trademark-container">
  <div class="trademark">
    ...
    *Republishing or repurposing any and all assets on this page is strictly forbidden. <br> <br>
    
<div class="copyright" style="font-size: 80%; color:white;">©LEVEL-5 Inc.</div>
  </div>
</div>
</footer>